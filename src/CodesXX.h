...
case ADD_xHL:  I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));
               M_ADD(I);break;
...
case SUB_xHL:  I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));
               M_SUB(I);break;
...
case AND_xHL:  I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));
               M_AND(I);break;
...
case OR_xHL:   I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));
               M_OR(I);break;
...
case ADC_xHL:  I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));
               M_ADC(I);break;
...
case SBC_xHL:  I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));
               M_SBC(I);break;
...
case XOR_xHL:  I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));
               M_XOR(I);break;
...
case CP_xHL:   I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));
               M_CP(I);break;
...
case DEC_xHL:  I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W));M_DEC(I);
               M_WRMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++),I);
               break;
...
case INC_xHL:  I=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W));M_INC(I);
               M_WRMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++),I);
               break;
...
case LD_xHL_B: J.W=R.XX.W+(offset)M_RDMEM(R.PC.W++);
               M_WRMEM(J.W,R.BC.B.h);break;
...
case LD_xHL_C: J.W=R.XX.W+(offset)M_RDMEM(R.PC.W++);
               M_WRMEM(J.W,R.BC.B.l);break;
...
case LD_xHL_D: J.W=R.XX.W+(offset)M_RDMEM(R.PC.W++);
               M_WRMEM(J.W,R.DE.B.h);break;
...
case LD_xHL_E: J.W=R.XX.W+(offset)M_RDMEM(R.PC.W++);
               M_WRMEM(J.W,R.DE.B.l);break;
...
case LD_xHL_H: J.W=R.XX.W+(offset)M_RDMEM(R.PC.W++);
               M_WRMEM(J.W,R.HL.B.h);break;
...
case LD_xHL_L: J.W=R.XX.W+(offset)M_RDMEM(R.PC.W++);
               M_WRMEM(J.W,R.HL.B.l);break;
...
case LD_xHL_A: J.W=R.XX.W+(offset)M_RDMEM(R.PC.W++);
               M_WRMEM(J.W,R.AF.B.h);break;

case LD_xBC_A: M_WRMEM(R.BC.W,R.AF.B.h);break;
case LD_xDE_A: M_WRMEM(R.DE.W,R.AF.B.h);break;

case LD_B_xHL:    R.BC.B.h=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));break;
case LD_C_xHL:    R.BC.B.l=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));break;
case LD_D_xHL:    R.DE.B.h=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));break;
case LD_E_xHL:    R.DE.B.l=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));break;
case LD_H_xHL:    R.HL.B.h=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));break;
case LD_L_xHL:    R.HL.B.l=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));break;
case LD_A_xHL:    R.AF.B.h=M_RDMEM(R.XX.W+(offset)M_RDMEM(R.PC.W++));break;
...
case LD_H_BYTE:   R.XX.B.h=M_RDMEM(R.PC.W++);break;
case LD_L_BYTE:   R.XX.B.l=M_RDMEM(R.PC.W++);break;
case LD_A_BYTE:   R.AF.B.h=M_RDMEM(R.PC.W++);break;
case LD_xHL_BYTE: J.W=R.XX.W+(offset)M_RDMEM(R.PC.W++);
                  M_WRMEM(J.W,M_RDMEM(R.PC.W++));break;

case LD_xWORD_HL:
  J.B.l=M_RDMEM(R.PC.W++);
  J.B.h=M_RDMEM(R.PC.W++);
  M_WRMEM(J.W++,R.XX.B.l);
  M_WRMEM(J.W,R.XX.B.h);
  break;

case LD_HL_xWORD:
  J.B.l=M_RDMEM(R.PC.W++);
  J.B.h=M_RDMEM(R.PC.W++);
  R.XX.B.l=M_RDMEM(J.W++);
  R.XX.B.h=M_RDMEM(J.W);
  break;
...
case EX_HL_xSP:
  J.B.l=M_RDMEM(R.SP.W);M_WRMEM(R.SP.W++,R.XX.B.l);
  J.B.h=M_RDMEM(R.SP.W);M_WRMEM(R.SP.W--,R.XX.B.h);
  R.XX.W=J.W;
  break;
